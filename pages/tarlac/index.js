...
import TarCarousel from '../../components/TarCarousel';
  ...
  return ( 
    <div className='h-full bg-primary/30 scrollbar overflow-y-scroll overflow-x-hidden scrollbar-thumb-accent scrollbar-thumb-rounded-full'>
        ...
        <div className='h-full py-32 xl:mx-[150px] mx-[20px] text-center'>
            ...
            >
                <span className='text-accent'>Tarlac</span> project design<span className='text-accent'>.</span>
            </motion.h2>
            {/* subtitle*/}
            <motion.p
            ...
            >
                Embrace the simplicity and charm of a modern bungalow. Designed with single-level living in mind, this home offers a seamless blend of comfort and style, making it the perfect retreat for those who value both function and form.
            </motion.p>
            {/* slider */}
            <motion.div
                ...
                <div className='container hover:bg-[#0234357a] transition-all duration-300 py-[20px]  rounded-lg mx-auto'>
                    ...
                    {/* title*/}
                        <div className='text-center flex flex-col lg:text-left mb-4 xl:mb-0'>
                            ...
                            >
                                Design overview<span className='text-accent'>.</span>
                            </motion.h1>
                            {/* subtitle*/}
                            <motion.p
                            variants={fadeIn('up', 0.3)} 
                            ...
                            >
                            This charming bungalow offers the perfect blend of comfort and functionality. With two spacious bedrooms, each complemented by two well-appointed toilets and baths, this home is designed for both relaxation and practicality. The open-concept living room flows seamlessly into the dining area, making it ideal for family gatherings. The modern kitchen, featuring a sleek island, is perfect for culinary adventures, while the attached garage provides convenient parking. Whether you're starting a family or downsizing, this bungalow is designed to meet all your needs.
                            </motion.p>
                        </div>
                        {/* image*/}
                        <div className='wfull'>
            ...
            {/* floor plan */}
                <div className='container mx-auto flex flex-col h-full xl:mt-[60px]'>
                    ...
                    {/* text */}
                    <div className='text-center flex flex-col items-end justify-end  lg:text-left mb-4 xl:mb-0 xl:mt-[-500px]'>
                        <motion.h1
                        variants={fadeIn('down', 0.4)} 
                        initial='hidden'
                        animate='show'
                        exit='hidden'
                        className='h3 xl:mt-8 justify-center items-center flex w-full lg:w-[30%] py-[50px]'
                        >
